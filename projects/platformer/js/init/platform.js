(function (window) {
    ...
    platform.init = function (game) {
        ...
        // example:
        platform.create(150, 150, .5, .1)
        platform.create(150, 250, .5, .1)
        platform.create(150, 350, .5, .1);
        platform.create(150, 450, .5, .1);
        platform.create(150, 550, .5, .1);
        platform.create(700, 450, 1, 0.1);
